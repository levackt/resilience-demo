...
/**
 * Sample {@link com.netflix.hystrix.HystrixCommand} that implements fallback logic that requires
 * network traffic and thus executes another {@link com.netflix.hystrix.HystrixCommand} from the {@link #getFallback()} method.
 * <p>
